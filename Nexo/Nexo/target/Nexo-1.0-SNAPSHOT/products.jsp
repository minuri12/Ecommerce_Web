...
<head>
    ...
    <script>
        function openUpdateModal(productId, productName, productDesc, productPrice, productDiscount, productQuantity, productCategoryId, productPhoto) {
            ...
            document.getElementById("updatePPhoto").src = 'img/products/' + productPhoto;
...
<body>
    ...
    <br>
    <h2 style="align-items: center;text-align: center">All Products</h2>
    <br>
    <% 
    ...
    %>
    <div class="container">
    <div class="row row-cols-2 row-cols-md-4 g-3 col-md-15 ml-0">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <form action="RemoveProductServlet" method="post" style="display: inline;">
                                    ...
                                    <button type="submit" style="background-color:#fe3f35;color:white;border-radius: 5px; padding: 10px; border: none;">Remove</button>
                                </form>
                            </div>
                        </div>
                    </div>
