...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-2 list-group" style="margin: 30px;margin-top: 40px;width: 350px">
            <a href="index.jsp" class="list-group-item list-group-item-action active" aria-current="true" style="background-color: #1fb622;border: solid 1px #1fb622;">
                All Products
            </a>
            <% for (Category c : categoryList) { %>
                <a href="?cat=<%= c.getCategoryId() %>" class="list-group-item list-group-item-action"><%= c.getCategoryTitle() %></a>  
            <% } %>
        </div>
                        ...
                        <div class="card h-100" style="width: 250px;">
                            ...
                            <div class="card-body">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                  ...
                                  <button class="btn btn-primary" style="background-color: black; border: none; font-size: 12px" onclick="addToCart(<%= product.getPId() %>, '<%= product.getPName() %>', <%= product.getPPrice() %>, <%= product.getPQuantity() %>)">Add to Cart</button>
